    ...
    return (
        ...
        <div className="px-3">
            ...
            <div className="flex gap-3">
             ...
             <div>
              <p className="text-gray-900 font-bold">Agente</p>
              <p className="text-secondary font-semibold">Luis P. Casas</p>
              ...
              <div className="my-5">
                ...
                <div className="flex justify-between gap-5 my-4">
                    ...
                    <button className="border-[1px] border-secondary text-secondary px-2 py-2 rounded-lg test-sm ">Llamar</button>
